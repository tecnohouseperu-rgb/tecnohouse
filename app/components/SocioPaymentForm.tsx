...
export default function Checkout() {
  ...
  // ✅ Modal Socio (fallback / alternativo)
  const [openSocioPay, setOpenSocioPay] = useState(false);
  const [createdOrderId, setCreatedOrderId] = useState<string>("");

  // ✅ Helper para abrir modal con orderId seguro
  const openSocio = () => {
  ...
  // ===== items MP con descuento proporcional
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-3 min-w-0">
                      {/* ✅ FIX IMAGENES: <img> directo (sin next/image, sin fill) */}
                ...
                <>
                  ...
                  <div className="px-3 pb-3">
                    <MercadoPagoPay
                      ...
                      // ✅ fallback: abrir Socio en vez de resetear todo
                      onPrefError={() => {
                        setMsg(
