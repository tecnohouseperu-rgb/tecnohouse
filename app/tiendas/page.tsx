      ...
      <section className="mt-6 grid gap-6 md:grid-cols-[1.2fr_1fr]">
        <div className="rounded-2xl border bg-white p-5 shadow-sm">
          ...
          <div className="mt-4 grid grid-cols-1 sm:grid-cols-3 gap-3">
            ...
            <Info label="Contacto" value="+51 908 631 949  (WhatsApp)" />
          </div>
        ...
        <aside className="rounded-2xl border bg-white p-5 shadow-sm">
          ...
          <div className="mt-3 flex flex-col gap-2">
            <Link href="https://wa.me/51908631949" target="_blank" className="inline-flex rounded-md border px-4 py-2 text-sm hover:bg-muted/70">
              WhatsApp
            </Link>
